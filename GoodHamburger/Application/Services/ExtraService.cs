...
namespace GoodHamburger.Application.Services
{
    public class ExtraService : IExtraService
    {
        ...
        public ExtraService(AppDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<List<Product>> GetAllAsync() => await _context.Products.Where(x => x.Type != EnumProductType.Sandwich).ToListAsync();
